...
# ╔═╡ 24c7eca0-dd10-11ec-18e7-819f6b1192ca
using PlutoUI: Slider

# ╔═╡ af89ce23-c11b-4c79-91d7-7eb2aa43e702
using CairoMakie

# ╔═╡ 2fcaabf1-5618-442a-8e16-46a9f403cb1d
@bind c1 Slider(0:0.1:5)

# ╔═╡ 3f07ecc7-9d53-4787-b604-a7172fab2901
@bind c2 Slider(0:0.1:5)

# ╔═╡ ef69d4a7-2b40-435d-99d6-e8b5c3a1617d
begin
	var = 0:0.1:5
	xx = c1 ./ (1 .+ var.^2)
	yy = c2 ./ (1 .+ var.^2)
...
# ╔═╡ 579e05ab-1fb9-4ecc-8f57-b700adc8201e
(c1, c2)

# ╔═╡ ca4d1d64-10de-47a6-86a3-b2b88f6c518e
begin
	fig, ax, plot = lines(xx, var)
	lines!(ax, var, yy)
	fig
end
